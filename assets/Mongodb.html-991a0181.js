import{_ as a,Q as s,S as t,U as e,W as d,X as l,a8 as n,a9 as c,H as r}from"./framework-d7e1aa10.js";const o={},v=e("h1",{id:"mongodb-简单使用",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#mongodb-简单使用","aria-hidden":"true"},"#"),n(" Mongodb 简单使用")],-1),u={class:"table-of-contents"},b=c(`<h1 id="插入文档" tabindex="-1"><a class="header-anchor" href="#插入文档" aria-hidden="true">#</a> 插入文档</h1><p>当向集合中插入文档时，如果没有指定文档的 <code>_id</code> 属性，数据库会自动为文档添加 <code>_id</code>，以此确保数据的唯一性</p><div class="language-mariadb line-numbers-mode" data-ext="mariadb"><pre class="language-mariadb"><code>/* 插入方法 */
...
/* 删除数据库 */
db.dropDatabase();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><h1 id="mongoose" tabindex="-1"><a class="header-anchor" href="#mongoose" aria-hidden="true">#</a> Mongoose</h1><p>mongoose 中提供了几个对象：</p><ul><li>Schema：模式对象，定义约束数据库中的文档结构</li><li>Model：作为集合中的所有文档的表示，相当于数据库中的 Collection</li><li>Document：表示集合中的具体文档，相当于集中的一个具体的文档</li></ul>`,16);function m(g,h){const i=r("router-link");return s(),t("div",null,[v,e("nav",u,[e("ul",null,[e("li",null,[d(i,{to:"#mongodb-简单使用"},{default:l(()=>[n("Mongodb 简单使用")]),_:1})]),e("li",null,[d(i,{to:"#插入文档"},{default:l(()=>[n("插入文档")]),_:1})]),e("li",null,[d(i,{to:"#查询文档"},{default:l(()=>[n("查询文档")]),_:1})]),e("li",null,[d(i,{to:"#修改文档"},{default:l(()=>[n("修改文档")]),_:1})]),e("li",null,[d(i,{to:"#删除文档"},{default:l(()=>[n("删除文档")]),_:1})]),e("li",null,[d(i,{to:"#mongoose"},{default:l(()=>[n("Mongoose")]),_:1})])])]),b])}const f=a(o,[["render",m],["__file","Mongodb.html.vue"]]);export{f as default};
